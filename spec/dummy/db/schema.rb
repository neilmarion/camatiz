...
ActiveRecord::Schema.define(version: 20190320040237) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "camatiz_channels", force: :cascade do |t|
    t.string   "name"
  ...
  create_table "camatiz_states", force: :cascade do |t|
    t.string   "name"
    t.integer  "user_id"
    t.integer  "inc"
    t.integer  "minutes"
  ...
  create_table "camatiz_users", force: :cascade do |t|
    t.string   "name"
    t.string   "slack_id"
